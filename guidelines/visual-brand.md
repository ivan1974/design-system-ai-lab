...
This file defines the visual brand rules Figma Make must follow when generating screens with `design-system-ai-lab` v0.4.

The goal is not to create decorative brand expression. The goal is to generate sober, operational, trustworthy B2B product screens.

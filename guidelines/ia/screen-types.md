...
This file defines which type of screen Figma Make should generate before it
chooses components.

Existing composition files explain how to compose components into decision
flows. This file sits one step earlier: it helps select the right screen
architecture.
...
Then choose the layout and components.
...
when the user asks for a workspace, queue or drill-down flow.

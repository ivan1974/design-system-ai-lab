                    ...
                    {options.map(opt => {
                      ...
                      return (
                        <label
                          ...
                          onClick={() => onToggleOption(category, opt)}
                        >
                          <div className={`w-4 h-4 rounded border flex items-center justify-center flex-shrink-0 transition-all ${checked ? 'bg-[#00985F] border-[#00985F]' : 'border-neutral-300 bg-white group-hover:border-neutral-400'
                            }`}>
                            {checked && (

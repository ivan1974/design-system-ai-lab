...
const rows = [
  {
    ...
    description: "CompanyName Advanced · QBR in 6 days · 54% connected",
  ...
  },
  {
    ...
    description: "CompanyName Standard · Monthly review in 12 days · 68% connected",
  ...
  },
  {
    ...
    description: "CompanyName Advanced · QBR in 35 days · 92% connected",

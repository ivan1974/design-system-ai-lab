...
| G-012 | P0 | Benchmarks | Benchmarks do not yet cover context drift and information overload | Add `contracts/benchmark.contract.json`, multi-turn cases, overload case and benchmark contract tests | Ready for review |
| G-013 | P0 | Repair routing | Repair prompts are not yet exposed through a minimal router | Create a short `guidelines/evaluation/repair/repair-router.md` and enforce the v0.6.0 repair families | Ready for review |
| G-014 | P1 | Package files | Package may expose too much historical or non-runtime context | Reduce package `files` to the v0.6.0 Make Kit surface and add a package-surface test | Ready for review |
...
| G-016 | P1 | Reference guidelines | Critical preferred components do not all have short GenAI-standard reference files | Rewrite only priority preferred component/pattern guidelines | Ready for review |
...
G-012 context drift and overload benchmarks — ready for review
G-013 repair router — ready for review
```
...
G-010 visual rules contract and tests
```

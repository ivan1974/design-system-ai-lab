...
| G-018 | P1 | Progressive disclosure | Information overload is recognized but not yet encoded as a runtime blocker | Add short runtime principle and overload benchmark; defer full component refactor to v0.7.0 | In progress |
| G-019 | P1 | Evidence and trust | Evidence rules are strong but spread across principles, domain models, guidelines and contracts | Consolidate active rules in `runtime/trust-action-rules.md` and align contracts | In progress |
| G-020 | P1 | Action ownership | Action ownership rules must remain visible across runtime, registry, review and repair | Ensure ActionRow / ActionCard / AlertCard rules require owner, due date and priority when actionable | In progress |
